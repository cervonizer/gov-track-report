...
export const mockPoliticians: Politician[] = [
  {
    ...
    promises: [
      ...
      {
        id: 'p20',
        title: 'Cumprir meta fiscal de déficit zero em 2024',
        description: 'Compromisso público de zerar o déficit primário do Governo Central em 2024, conforme arcabouço fiscal.',
        ...
        sources: [
          ...
          { label: 'Min. Fazenda — Mudança da meta (LDO)', url: 'https://www.gov.br/fazenda/pt-br' },
        ],
      },
      {
        id: 'p21',
        title: 'Reonerar a folha de pagamento de 17 setores',
        description: 'Promessa de reonerar gradualmente setores beneficiados pela desoneração da folha para sustentar a Previdência.',
        ...
        category: 'Economia',
        sources: [
          { label: 'Planalto — Lei 14.973/2024 (manteve desoneração até 2027)', url: 'https://www.planalto.gov.br/ccivil_03/_ato2023-2026/2024/lei/L14973.htm' },
        ],
      },
      {
        id: 'p22',
        title: 'Zerar a fila do SUS para cirurgias eletivas',
        description: 'Compromisso de zerar a fila de procedimentos eletivos do SUS por meio do Programa Nacional de Redução de Filas.',
        ...
        category: 'Saúde',
        sources: [
          { label: 'Ministério da Saúde — Redução de Filas', url: 'https://www.gov.br/saude/pt-br/assuntos/noticias/2023/maio/ministerio-da-saude-lanca-programa-de-reducao-de-filas-no-sus' },
          { label: 'CONASS', url: 'https://www.conass.org.br/' },
        ],
      },
      {
        id: 'p23',
        title: 'Não privatizar Petrobras e reverter privatização da Eletrobras',
        description: 'Compromisso de campanha de barrar privatizações de estatais estratégicas e rever a venda da Eletrobras.',
        datePromised: '2022-10-30',
        deadline: '2026-12-31',
        status: 'Broken',
        progress: 30,
        category: 'Energia',
        sources: [
          { label: 'Agência Câmara — Eletrobras', url: 'https://www.camara.leg.br/noticias/873912-camara-aprova-mp-da-privatizacao-da-eletrobras' },
        ],
      },
      {
        id: 'p24',
        title: 'Revogar o Teto de Gastos sem aumentar a dívida',
        description: 'Substituir o Teto de Gastos por novo arcabouço fiscal mantendo a dívida pública em trajetória sustentável.',
        ...
        sources: [
          { label: 'Planalto — LC 200/2023', url: 'https://www.planalto.gov.br/ccivil_03/leis/lcp/lcp200.htm' },
          { label: 'BCB — Estatísticas Fiscais', url: 'https://www.bcb.gov.br/estatisticas/estatisticasfiscais' },
        ],
      },
    ],
    proposals: [
