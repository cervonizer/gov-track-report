...
export const legacyDataMap: Record<string, LegacyData> = {
  ...
  "1": {
    ...
    performance: [
      ...
      },
      {
        ...
        metrics: [
          ...
          { label: "Focos de queimada no Pantanal", before: "8.182", after: "12.581", change: "+53,8%", positive: false, sources: [{ label: "INPE — Programa Queimadas", url: "https://terrabrasilis.dpi.inpe.br/queimadas/situacao-atual/" }] },
          { label: "Área queimada no Brasil (mi ha)", before: "16,3", after: "30,8", change: "+89%", positive: false, sources: [{ label: "MapBiomas Fogo", url: "https://brasil.mapbiomas.org/" }] },
        ],
      },
    ],
    chart1: {
    ...
    footnote: "Dados consolidados até dezembro de 2024. Comparação entre governo Bolsonaro (2019–2022) e Lula (2023–2024). Indicadores apresentados de forma equilibrada — incluem avanços e retrocessos.",
    dataSources: [
