        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 mx-auto">
          <div className="relative w-full sm:w-[360px]">
            ...
            <Input
              ...
              className="pl-12 h-14 text-lg bg-background w-full"
              value={searchQuery}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-primary-foreground/80">
              Complete profiles with voting history and promises
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-primary-foreground/80">
              Sourced directly from government websites and records
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-primary-foreground/80">
              Stay informed with the latest votes and proposals
            </p>
          </div>
        </div>
      </div>
