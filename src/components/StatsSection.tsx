        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="text-center">
            <CardContent className="p-6">
              ...
              <div className="text-3xl font-bold text-primary mb-2">{fmt(totalPoliticians)}</div>
          ...
          <Card className="text-center">
            <CardContent className="p-6">
              ...
              <div className="text-3xl font-bold text-success mb-2">{fmt(totalPromises)}</div>
          ...
          <Card className="text-center">
            <CardContent className="p-6">
              ...
              <div className="text-3xl font-bold text-warning mb-2">{fmt(totalVotes)}</div>
